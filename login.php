...
<body class="min-h-screen bg-gradient-to-br from-amber-50 via-green-50 to-yellow-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md relative z-10 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border-0 p-8">
        <div class="text-center pb-8">
            ...
            <h2 class="text-2xl text-green-800 font-bold">Welcome Back</h2>
            <p class="text-green-600 mt-2">Sign in to your Poorna Oils account</p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center text-xs uppercase">
                    <span class="bg-white px-2 text-green-600">Or continue with email</span>
                </div>
            </div>
            ...
            <form method="POST" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword()" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500 hover:text-green-700">
            ...
            <div class="text-center">
                <p class="text-green-600">
                    ...
                    <a href="signup.php" class="text-green-700 hover:text-green-900 font-medium ml-1">Sign up</a>
                </p>
            </div>
        </div>
    </div>
